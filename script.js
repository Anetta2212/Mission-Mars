...
const G = {
  ...
  // постійні бонуси від відкритих зон поверхні
...
// кольорові піни на карті відповідно до стану
function updPins() {
...
function zBonus(z) {
  ...
  switch (z.bt) {
    ...
    case 'o2': rv('o2'); break;
    case 'h2oreg': b.wr += 0.05; break;
    case 'rpreg': b.rr += 0.3; break; 
    case 'ebst': b.eb += 0.25; break;    
    case 'rplabbst': b.rlb += 0.25; break; 
  }
}
